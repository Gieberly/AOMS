...
<body>
    ...
    <ul class="side-menu top">
        <li class="">
            <a href="../admin/dashboard_admin.php" id="dashboard-link"  style="text-decoration:none">
                <i class='bx bxs-dashboard'></i>
                <span class="text">Dashboard</span>
            </a>
        </li>
        <li class="">
            <a href="admin_Applicants.php" id="dashboard-link"  style="text-decoration:none">
        ...
        <li class="">
            <a href="admin_masterlist.php" id="master-list-link" style="text-decoration:none">
        ...
        <li class="">
            <a href="../admin/users_admin.php" id="student-result-link" style="text-decoration:none">
                <i class='bx bx-id-card'></i>
                <span class="text">Manage Personnel</span>
            </a>
        </li>
        <li class="">
            <a href="../admin/faculty_admin.php" id="data-info-link" style="text-decoration:none">
            <i class='bx bxs-group'></i>
                <span class="text">Manage Faculty/Staff</span>
            </a>
        </li>
        <li class="">
            <a href="Data_Insert.php" id="data-result-link" style="text-decoration:none">
        ...
        <li class="">
            <a href="../admin/data_admin.php" id="data-info-link" style="text-decoration:none">
    ...
    <section id="content">
        <nav>
            ...
            ?>
                <form action="admin_Applicants.php" method="GET">
                    <div class="form-input">
                        <input type="search" name="search" placeholder="Search...">
            ...
            ?>
                    <?php
            $current_page = basename($_SERVER['PHP_SELF']);
            if ($current_page === 'manage_users.php') {
            ?>
                <form action="admin_Applicants.php" method="GET">
                    <div class="form-input">
                        <input type="search" name="search" placeholder="Search...">
