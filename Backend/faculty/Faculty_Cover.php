...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            <li class="">
                <a href="Faculty_Dashboard.php" id="dashboard-link" onclick="clearSearchFilter()">
                    <i class='bx bxs-dashboard'></i>
                    <span class="text">Dashboard</span>
                </a>
            </li>
            <li >
                <a href="Faculty_Applicants.php" onclick="clearSearchFilter()">
    ...
    <section id="content">
        ...
        <nav>
            ...
            if ($current_page === 'Faculty_Applicants.php') {
            ?>
                <form action="Faculty_Applicants.php" method="GET">
