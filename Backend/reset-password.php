...
<body>
    ...
    <section class="content">
        ...
        <div class="form" id="loginForm" style="display: block;">
            <form action="process_reset.php" method="POST" id="#login_page">
                ...
                <br>
                    ...
                    <button class="btn btn-success" style="border-radius:5px"  id="send_reset" name="send_reset">Change Password</button>
            </form>
        </div>
    </section>
