...
if (!isset($_SESSION['user_type']) || $_SESSION['user_type'] !== 'OSS') {
...
<body>
    ...
    <section id="sidebar">
        <a class="brand">
            ...
            <span class="text">OSS</span>
        </a>

        <ul class="side-menu top">
            <li class="">
                <a href="OSS_Dashboard.php" id="dashboard-link" onclick="clearSearchFilter()">
            ...
            <li class="">
                <a href="OSS_Applicants.php" id="master-list-link" onclick="clearSearchFilter()">
    ...
    <section id="content">
        <nav>
            ...
            if ($current_page === 'OSS_Applicants.php') {
            ?>
                <form action="OSS_Applicants.php" method="GET">
