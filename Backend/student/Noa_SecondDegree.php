...
<body onload="downloadPDF()">
    <div class="page-containerr" id="DownloadForm">
     ...
     <div class="inline-heading">
            ...
            <p class="head-red">(Second Degree)</p>
        </div>
            ...
            <ol style="font-size: 14.5px;">
                ...
                <ol type="a">
                    ...
                    <li><strong>Original Copy of Certificate of Good Moral Character</strong> from the last school
                        attended;</li>
                    <li><strong>Original Certificate of Transfer Credential (CTC) </strong>and copy of your <strong>Transcript or Grades </strong>,from last school attended; <strong>and</strong></li>
                    <li>If you are a BSU graduate, submit an <strong>Original copy of your Transcript of Records</strong>;</li>
                    <li>If you are a graduate of another school, submit an <strong>Original Copy of Certificate of Transfer Credential(CTC)</strong> and an Original copy of your <strong>Transcript or Grades</strong> from last school attended.</li>
                ...
                <li><strong>LABORATORY TEST RESULTS</strong>
                    <ol>
                        <li><strong>Chest X-ray taken</strong> by any <strong>authorized X-ray Laboratory
                                Facility</strong> available in your locality. <strong style="font-size: 12px;"><u>Detach</u> the Request for Chest X-ray which is found in the lower portion of this Notice of Admission and present it to the concerned X-ray laboratory personnel</strong>
.</li>
...
<script>
   function downloadPDF() {
        ...
        var opt = {
            margin: 0.29,
            html2canvas: { scale: 5 },
            filename: 'Second Degree NOA.pdf',
