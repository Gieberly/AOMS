...
<section id="content">
    ...
    <div class="overlay_applicant"></div>
    <div class="box">
...
let overlay_applicant = document.querySelector(".overlay_applicant");
    let box = document.querySelector(".box");
    let close = document.querySelector(".close");

    // Show the box and overlay_applicant when the page loads if it hasn't been closed before
    window.addEventListener('DOMContentLoaded', function () {
        if (!localStorage.getItem('boxClosed')) {
            overlay_applicant.style.display = "block";
    ...
    close.addEventListener("click", () => {
        ...
        overlay_applicant.style.display = "none";
