...
// Query to fetch data from users table for specified user types
$query = "SELECT * FROM users WHERE userType IN ('Personnel', 'Faculty', 'OSS')";
...
<body>
    ...
    while ($staff = $result->fetch_assoc()) {
        ...
        echo "<td>{$staff['mname']}</td>";
        echo "<td>{$staff['email']}</td>";
        echo "<td>{$staff['created_date']}</td>";
