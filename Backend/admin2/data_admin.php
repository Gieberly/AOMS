    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="head-title">
                ...
                <div class="right">
                    <a href="AppointmentDate.php" class="btn appointment">
                        <i class='bx bxs-calendar calendar-icon'></i>
                        <span class="text">Set Appointment Dates</span>
                    </a>
                    <br>
                    <a href="excel_export_appointments.php" class="btn-Export">
                            ...
                            <tbody id="tbody">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                          ...
                                          <button type='button' class='button delete-btn' id='button delete-btn 'data-tooltip='Delete' onclick='deleteRow(" . $row['id'] . ")'><i class='bx bx-message-alt-x' ></i></button>

                                          <button type='button' class='button check-btn' data-tooltip='Retrieve' ><i class='bx bx-undo'></i></button>
...
<div class="success-message" id="archive" style="display: none;">
  <p id="archive-message"></p>
                        ...
                        <form id="updateProfileForm2" class="tab1-content" method="post"
                            ...
                            document.getElementById("applicant_number").addEventListener("click", function() {
                                ...
                                if (!modalShown) {
                                    ...
                                    modalShown =
                                    true; // Set modalShown to true to indicate the modal has been shown
                                }
                            });
                            ...
                            <div class="data-container3">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="small-label" for="nature_of_degree"
                                        style="white-space: nowrap;">Nature of degree</label>
                            ...
                            <div class="data-container3">
                                ...
                                <div class="form-group">
                                    <label class="small-label" for="high_school_name_address"
                                        style="white-space: nowrap;">LAST SCHOOL ATTENDED</label>
    ...
    function confirmSubmission() {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    ...
                    .submit(); // Assuming your form ID is "updateProfileForm"
                    }
                } else {
        ...
        xhr.open("POST", "check_applicant_number.php",
        true); // Replace "check_applicant_number.php" with your PHP script to check the database
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    ...
                    document.getElementById('alertMessage').innerText =
                        'Failed to send to the OSS. Please try again later.';
                    document.getElementById('alertModal').style.display = 'block';
                }
            }
        };
